          ...
          ListEmptyComponent={
            <View style={s.empty}>
              <View style={s.emptyIconWrap}>
                <Ionicons name="person-outline" size={38} color="#374151" />
              </View>
              <Text style={s.emptyTitle}>No teachers found</Text>
              <Text style={s.emptySub}>
                {search ? "Try a different search term" : "No teachers in this college yet"}
              </Text>
            </View>
          }
