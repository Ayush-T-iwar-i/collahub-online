    ...
    <View style={{ flex: 1 }}>
      ...
      <Animated.View style={[styles.container, animatedCardStyle]}>
        <BlurView intensity={90} tint="dark" style={styles.card}>
          ...
          <Pressable onPress={() => router.push("/student/forgot")} style={styles.forgotBtn}>
...
const styles = StyleSheet.create({
  ...
  iconCircle: {
    ...
    marginBottom: 12, borderWidth: 1, borderColor: "rgba(0,198,255,0.3)",
  },
  ...
  forgotText: { color: "#00c6ff", fontSize: 13 },
  ...
  registerLink: { color: "#00c6ff", fontWeight: "700" },
});