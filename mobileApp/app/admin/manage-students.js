          ...
          <View style={styles.card}>
            ...
            <View style={styles.cardInfo}>
              ...
              <View style={styles.tagsRow}>
                ...
                {item.section && <View style={[styles.tag,{backgroundColor:"rgba(52,211,153,0.15)"}]}><Text style={[styles.tagText,{color:"#34d399"}]}>Sec {item.section}</Text></View>}
            ...
            {batchType==="semester" ? (
              <>
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{gap:8,marginBottom:20}}>
                  {SEMESTERS.map(s => (
                    <Pressable key={s} onPress={() => setBatchSemester(s)} style={[styles.chip,batchSemester===s&&styles.chipGreen]}>
              ...
              <>
                ...
                <View style={{flexDirection:"row",gap:10,marginBottom:20}}>
                  {SECTIONS.map(s => (
                    <Pressable key={s} onPress={() => setBatchSection(s)} style={[styles.chip,batchSection===s&&styles.chipPurple]}>
